...
function IssaVenteCreate() {
  ...
  async function handleSubmit(e) {
    ...
    for (const line of productLines) {
      ...
      const { error: lineError } = await supabase.from("issaventeproduits").insert(linePayload);
      ...
      <form className="product-form" onSubmit={handleSubmit}>
        ...
        */}
        ...
        <div className="grid">
                ...
                <button className="profile_back" onClick={() => navigate("/issaventes")}>
                    Annuler
                </button>
        </div>
...
export default IssaVenteCreate;
